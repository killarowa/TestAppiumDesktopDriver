...
namespace ContactBook.DesktopClientTests
{
    public class DesktopTest
    {
        ...
        public void StartApp()
        {
            ...
            options.AddAdditionalCapability("app", @"C:\Work\ContactBook-DesktopClient\ContactBook-DesktopClient.exe");
        ...
        public void Test_SearchContact_VerifyFirstResult()
        {
            ...
            urlField.Clear();
            urlField.SendKeys(@"C:\Work\ContactBook-DesktopClient\ContactBook-DesktopClient.exe");
